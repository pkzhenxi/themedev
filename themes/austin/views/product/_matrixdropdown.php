...
<div class="col-sm-5">
    <div class="row">
        ...
        <div class="matrix-label label label-default col-sm-4 col-xs-4"><?= $model->SizeLabel?></div>

        <div class="matrix-menu">
        <?php
            echo CHTML::activeDropDownList($model,'product_size',$model->Sizes,array(
                'id'=>'SelectSize',
                'class'=>'btn btn-default dropdown-toggle col-sm-7 col-xs-7',
                'prompt'=>Yii::t('global','Choose an Option'),
                'ajax' => array(
                    'type'=>'POST',
                    'dataType'=>'json',
...
<div class="col-sm-5">
    <div class="row">
        <span class="matrix-label label label-default col-sm-4 col-xs-4"><?= $model->ColorLabel?></span>
        <div class="matrix-menu">
        <?php
            echo CHTML::activeDropDownList($model,'product_color',array(),array(
                'id'=>'SelectColor',
                'class'=>'btn btn-default dropdown-toggle col-sm-7 col-xs-7',
                'prompt'=>Yii::t('global','Choose a Size First'),
                'ajax' => array(
                    'type'=>'POST',
                    'dataType'=>'json',
