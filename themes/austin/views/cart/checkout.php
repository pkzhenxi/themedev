...
<div class="modal-header">
    <h1 class=""><?= Yii::t('checkout','Checkout') ?></h1>
        ...
        <?php if(count($model->objAddresses)>0): ?>
            ...
            <div class="row">
                <div id="CustomerContactShippingAddress">
                    <h2 class="hidden-xs col-sm-4"><?= Yii::t('checkout','Choose shipping address'); ?></h2>
                    <div class="billing-address">
                        <h2 class="hidden-xs col-sm-offset-1 col-sm-4"><?= Yii::t('checkout','Choose billing address'); ?></h2>
                    </div>
                </div>
            </div>
