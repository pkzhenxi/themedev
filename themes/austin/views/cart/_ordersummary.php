<?php if (!isset($model)) $model = Yii::app()->shoppingcart; ?>


<div id="order-summary" class="pull-right col-sm-4">
    <div class="row">
        <div class="cart_price col-sm-6"><h4><?= Yii::t('cart','Subtotal'); ?></h4></div>
        <div id="cartSubtotal" class="cart-price col-sm-6 text-right"><h4><?= _xls_currency($model->subtotal); ?></h4></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 cart-price text-right"><h4><?= _xls_currency($model->shipping_sell); ?></h4></div>
    </div>
    <div class="row">
        <div class="col-sm-6"><h2><?= Yii::t('cart',"Total"); ?></h2></div>
        <div class="col-sm-6 cart-price text-right"><h2><?= _xls_currency($model->total); ?></h2></div>
    </div>
