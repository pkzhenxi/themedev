...
<div id="checkout">
    ...
    ?>
        ...
        <div id="customercontact">
	        <div class="row">
                <h3 class="col-sm-5"><?php echo Yii::t('checkout','Customer Contact'); ?></h3>
                <h3 class="col-sm-5"><?php
	        ...
	        <div class="col-sm-5">
                ...
                <div class="form-group">
                    <?php echo $form->label($model,'newsletter_subscribe',array('class'=>'')); ?>
                    <?php echo $form->checkBox($model,'newsletter_subscribe',array('class'=>'form-control')); ?>
                    <?php echo $form->error($model,'newsletter_subscribe'); ?>
                </div>
		    </div>

	<div class="row">
        <div class="submitblock col-sm-3" >
			<?php echo CHtml::submitButton('Submit', array('id'=>'btnSubmit','class'=>'btn btn-default'));  ?>
        </div>
