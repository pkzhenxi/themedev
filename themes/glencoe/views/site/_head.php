...
<!--	--><?php //Yii::app()->getClientScript()->registerCssFile(Yii::app()->theme->baseUrl.'/css/'.Yii::app()->theme->config->CHILD_THEME.'.css'); ?>
	...
	<?php Yii::app()->getClientScript()->registerCssFile(Yii::app()->theme->baseUrl.'/css/glencoe.css'); ?>
	<?php Yii::app()->getClientScript()->registerCssFile(Yii::app()->theme->baseUrl.'/css/offcanvas.css'); ?>
