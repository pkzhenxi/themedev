...
<div id="orderdisplay">
		...
		<div class="row-fluid">
	        <div class="span12">
	            <h1 class="page-title"><?= Yii::t('global','Welcome'); ?> <?= $model->first_name ?></h1>
	        </div>
	        <div class="span12 subcategories right">
		        <p class="button-reg edit-profile"><?= CHtml::link(Yii::t('global','Edit Profile'),Yii::app()->createUrl('myaccount/edit')); ?></p>
	        </div>
		</div>
	...
	<fieldset class="span12">
		<div class="row-fluid">
			<div class="span12"><h2><?= Yii::t('global','My Addresses') ?>:</h2></div>
			<div class="span12 subcategories right"><p class="button-reg add-wl"><?= CHtml::link(Yii::t('global','Add new address'),Yii::app()->createUrl('myaccount/address')); ?></p></div>
		</div>
	...
	<fieldset class="span12">
		...
		<?php if(count($model->carts(array('scopes'=>'complete'))) > 0): ?>
		  ...
		  <?php endforeach; ?>
		<?php else: ?>
			<?= Yii::t('global','<p>You have not placed any orders with us yet</p>'); ?>
		<?php endif; ?>
	...
	<fieldset class="span12">
	    <div class="row-fluid">
	        <div class="span12"><h2><?= CHtml::link(Yii::t('global','My Wish Lists'),Yii::app()->createUrl('/wishlist')); ?></h2></div>
	        <div class="span12 subcategories right"><p class="button-reg add-wl"><?= CHtml::link(Yii::t('global','Click here to create a wish list.'),Yii::app()->createUrl('wishlist/create')); ?></p></div>
	    </div>
	    <div class="row-fluid">
