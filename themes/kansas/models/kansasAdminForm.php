...
class kansasAdminForm extends ThemeForm
{
	 ...
	 */
	protected $name = "Kansas";
	protected $thumbnail = "brooklyn.png";
	protected $version = 3;
	protected $description = "Flat";
	...
	public $CATEGORY_IMAGE_HEIGHT = 512;
	public $CATEGORY_IMAGE_WIDTH = 512;
	public $DETAIL_IMAGE_HEIGHT = 512;
	public $DETAIL_IMAGE_WIDTH = 512;
	public $LISTING_IMAGE_HEIGHT = 400;
	public $LISTING_IMAGE_WIDTH = 400;
	public $MINI_IMAGE_HEIGHT = 100;
	public $MINI_IMAGE_WIDTH = 100;
	public $PREVIEW_IMAGE_HEIGHT = 128;
	public $PREVIEW_IMAGE_WIDTH = 128;
	public $SLIDER_IMAGE_HEIGHT = 256;
	public $SLIDER_IMAGE_WIDTH = 256;
