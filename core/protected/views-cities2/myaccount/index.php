...
<div id="orderdisplay">
		...
		<div class="row">
	        ...
	        <div class="col-sm-3 subcategories right">
	...
	<fieldset class="col-sm-12">
		<div class="row">
			...
			<div class="col-sm-4 subcategories right"><?= CHtml::link(Yii::t('global','Add new address'),Yii::app()->createUrl('myaccount/address')); ?></div>
		</div>
	...
	<fieldset class="col-sm-12">
	    <div class="row">
	        ...
	        <div class="col-sm-4 subcategories right"><?= CHtml::link(Yii::t('global','Click here to create a wish list.'),Yii::app()->createUrl('wishlist/create')); ?></div>
	    </div>
	    <div class="row">
