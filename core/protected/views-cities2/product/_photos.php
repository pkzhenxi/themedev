<div class="row">
	...
	<?php $this->widget('ext.Yii-Image-Zoomer.YiiImageZoomer',array(
		...
		'magvertcenter'=>false,
		'width'=>Yii::app()->theme->config->DETAIL_IMAGE_WIDTH,
		'height'=>Yii::app()->theme->config->DETAIL_IMAGE_HEIGHT,
		'magnifierpos'=>'left',
		'css_target'=>'targetarea col-sm-11',
		'css_thumbs'=>'image1 thumbs col-sm-11',
