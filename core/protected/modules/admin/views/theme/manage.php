		...
		<div id="thememanage">
			...
			<?php
				...
				foreach($arrThemes as $key=>$objTheme):
					echo '<div class="span4 theme"><div class="themetitle">'.$objTheme['name'].'</div><div class="themeversion">'.$objTheme['version'].'</div><div class="clearfix"></div><div class="themeselect" >';
