...
class ImagesType {
	...
	public static function GetSize($intImageTypeId) {
		...
		$intWidth = Yii::app()->theme->info->$strCfgWidth; //_xls_get_conf($strCfgWidth, $intDefWidth);
		$intHeight = Yii::app()->theme->info->$strCfgHeight; //_xls_get_conf($strCfgHeight, $intDefHeight);
