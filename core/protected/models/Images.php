...
class Images extends BaseImages
{
	...
	*/
	public static function GetLink($id, $intType = ImagesType::normal, $AbsoluteUrl = false)
	{
		...
		return
			"http://res.cloudinary.com/lightspeedretail/image/upload/c_fit,h_".
			$intHeight.",w_".$intWidth."/v1386188745/no_product_erczwq.png";
...
//			$strName .= '-' . $strClass;
	...
	*/
	public static function GetImageFallbackPath($AbsoluteUrl = false) {
		return
			"http://res.cloudinary.com/lightspeedretail/image/upload/c_fit,h_190,w_190/v1386188745/no_product_erczwq.png";
